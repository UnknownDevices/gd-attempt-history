...
#ifndef FLATBUFFERS_GENERATED_ATTEMPTHISTORY_GD_ATTS_HISTORY_FBS_H_
#define FLATBUFFERS_GENERATED_ATTEMPTHISTORY_GD_ATTS_HISTORY_FBS_H_
...
struct Attempt FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<float>(verifier, VT_START_PERC) &&
           VerifyField<float>(verifier, VT_END_PER) &&
...
}  // namespace gd_atts_history

#endif  // FLATBUFFERS_GENERATED_ATTEMPTHISTORY_GD_ATTS_HISTORY_FBS_H_
